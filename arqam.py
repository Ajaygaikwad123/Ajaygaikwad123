...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/arqamcanary/2*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*@arqamnabi*", parse_mode='Markdown')
